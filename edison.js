...
box1.addEventListener("click", () => {
  ...
  window.open("https://youtube.com/playlist?list=PL_S_MAIn05n66k5lCb3joz_fcQehF1pIe")
  // localStorage.clear()
});
...
box2.addEventListener("click", () => {
  if (count != "b") {
    ...
    window.open("https://youtube.com/playlist?list=PLnb0FwCbM-50UuNjpeIrdEnlSbbMK891Q")
      // localStorage.clear()
  }
});
...
box3.addEventListener("click", () => {
  if (count != "c") {
    ...
    window.open("https://drive.google.com/drive/folders/1eXbMMd01yebwBcY6wsNdEX5QPLsLcsGP?usp=sharing")
