...
box1.addEventListener("click", () => {
  ...
  window.open("https://youtube.com/playlist?list=PL0eyrZgxdwhwNC5ppZo_dYGVjerQY3xYU")
  // localStorage.clear()
});
...
box3.addEventListener("click", () => {
  if (count != "c") {
    ...
    window.open("https://youtube.com/playlist?list=PLsyeobzWxl7poL9JTVyndKe62ieoN-MZ3")
